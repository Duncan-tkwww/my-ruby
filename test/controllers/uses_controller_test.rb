...
class UsesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create use" do
    assert_difference('Use.count') do
      post uses_url, params: { use: { active: @use.active, first_name: @use.first_name, last_name: @use.last_name } }
    end
  ...
  test "should update use" do
    patch use_url(@use), params: { use: { active: @use.active, first_name: @use.first_name, last_name: @use.last_name } }
